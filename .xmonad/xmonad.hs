...
myWorkspaces = [" dev ", " www ", " sys ", " doc ", " pdc ", " chat ", " pdf ", " ent ", " files "]
...
myKeys =
	...
	, ("M-p f", spawn "~/.config/dmscripts/explore-with-dmenu.sh") --test
    ...
    -- KB_GROUP Apps
        , ("M-a t", spawn "thunar")
        , ("M-a f", spawn "flameshot gui")
        , ("M-a d", spawn "discord")
        , ("M-a v", spawn "code")
        , ("M-a y", spawn "freetube")
	, ("M-a r", spawn "remarkable")
